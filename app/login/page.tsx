  ...
  return (
    <div>
      ...
      <div className="bg-bg py-[22px]">
        <p className="mx-auto text-[17px] text-light-gray-bg leading-[1.35] max-w-[1024px] px-[22px]">An interactive product catalog application featuring user authentication, search filtering, and dynamic routing. Built as a portfolio project to demonstrate core skills in developing modern web applications with Next.js and the React ecosystem.</p>
      </div>
      <LoginForm />
    </div>
  )
